...
function Header() {
    return (
      <div className="landing-header">
       ...
       <br />
       <Button href="\join" variant="contained" sx={{borderRadius:"5rem",background: "purple", color:"white", WebkitTextStroke: '1px black', fontWeight:"bold" ,width: "clamp(250px, 25vw, 500px)", height: "clamp(80px, 10vw, 120px)", marginLeft:"clamp(10px, 2.5vw, 200px)", fontSize: "clamp(2rem, 4vw, 4rem)"}}>Play</Button>
