...
import Charts from "../LandingPage/Charts.tsx";
import Team from "../LandingPage/Team.tsx";
    ...
    >
      <Box
        sx={{
          ...
          textAlign: "center",
          background:
            "linear-gradient(180deg, #CBC3E3, #CBC3E3,#CBC3E3, #CBC3E3, white)",
          paddingBottom: "15vh",
        }}
      >
        <br id="Goal" />
