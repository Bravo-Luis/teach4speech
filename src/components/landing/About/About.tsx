    ...
    <Box className={commonClasses.ColumnCenteredContainer}>
      ...
      <Box sx={{ display: "flex", flexDirection: "row", flexWrap: "wrap", alignItems:"center", justifyContent:"center", gap:"2.5vw", padding:"2.5vw" }}>
        ...
        <Typography component="span" sx={{ maxWidth: "600px", textAlign:"left", width: "clamp(200px, 80%, 800px)", }}>
          Confidence in speaking increased across gender after just one week of
          Teach4Speech lessons. Confidence in small group discussion for girls
          increased by 22%.
        </Typography>
      </Box>
      ...
      <Typography component="span" sx={{ maxWidth: "600px", textAlign:"left", width: "clamp(200px, 80%, 800px)", }}>
      After just one week of the program, students of Hispanic backgrounds reported a 16% increase in confidence for speaking in small groups. In public speaking, confidence increased by 8% and speaking to adults increased by 7%.
        </Typography>
        <img
          src={ConfHispanic}
